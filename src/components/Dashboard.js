...
const StadiumMinimap = ({ zones, focusedZoneName, setFocusedZoneName }) => {
  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-5 flex flex-col justify-between h-full">
      ...
      <div className="grid grid-cols-4 grid-rows-5 gap-2 bg-slate-950/60 p-4 rounded-xl border border-border/50 w-full aspect-square max-w-[240px] mx-auto select-none">
        {layout.map(item => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 p-4 sm:p-6">
      ...
      <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 bg-card bg-opacity-50 backdrop-blur-sm rounded-2xl border border-border">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-card border border-border rounded-lg select-none">
            ...
            <span className="text-sm text-text-secondary font-medium">{coordinator}</span>
          </div>
        </div>
      </header>
            ...
            <div className="bg-card border border-border rounded-2xl p-5 flex flex-col justify-between h-full relative overflow-hidden">
              ...
              <div>
                ...
                <div className="mt-4 p-3.5 bg-accent/5 border border-accent/15 rounded-xl flex items-start gap-3">
                  <svg className="w-5 h-5 text-accent flex-shrink-0 mt-0.5 animate-bounce-subtle" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {activeIncidents.length > 0 && (
        <section className="bg-card border border-border rounded-2xl overflow-hidden animate-slide-in">
      ...
      <section>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 select-none">
          <h2 className="text-xl font-bold text-text-primary">Stadium Zones</h2>
      ...
      {showShortcutsHelp && (
        <div className="fixed inset-0 z-50 bg-background/85 backdrop-blur-md flex items-center justify-center p-4 animate-fade-in">
      ...
      {/* Toast Notification */}
      {toastMsg && (
        <div className="fixed bottom-5 right-5 z-50 bg-slate-900 border border-accent/35 rounded-xl px-4 py-2.5 shadow-glow flex items-center gap-2.5 text-xs font-semibold text-accent animate-fade-in select-none">
          <span className="w-2.5 h-2.5 bg-accent rounded-full animate-ping absolute -top-1 -right-1" />
