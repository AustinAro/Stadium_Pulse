...
export const IncidentItem = ({ incident, onAcknowledge, onResolve }) => {
  ...
  return (
    <div
      className={`relative ${severityColors[incident.severity]} border rounded-xl p-4 transition-all duration-300 animate-slide-in ${incident.acknowledged ? 'opacity-60' : ''}`}
    >
      <div className="flex items-start gap-3">
        <div className="flex-shrink-0 mt-0.5">{severityIcons[incident.severity]}</div>
